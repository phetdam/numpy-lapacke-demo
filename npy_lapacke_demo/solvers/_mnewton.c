...
PyDoc_STRVAR(
  ...
  "    Parameter controlling the multiplicative increase of the value added\n"
  "    to the diagonal of the Hessian matrix each iteration if the modified\n"
  "    Hessian is not yet positive definite.\n"
  "**ignored\n"
